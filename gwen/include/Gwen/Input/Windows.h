			...
			public:
				...
				bool ProcessMessage( MSG msg )
				{
					...
					switch ( msg.message )
					{
						...
						case WM_LBUTTONDOWN:
							{
								auto ret = m_Canvas->InputMouseButton(0, true);
								if (ret)
									SetCapture( msg.hwnd );
								return ret;
							}
						...
						case WM_LBUTTONUP:
							{
								auto ret = m_Canvas->InputMouseButton(0, false);
								if (ret)
									ReleaseCapture();
								return ret;
							}
						...
						case WM_RBUTTONDOWN:
							{
								auto ret = m_Canvas->InputMouseButton(1, true);
								if (ret)
								   SetCapture(msg.hwnd);
								return ret;
							}
						...
						case WM_RBUTTONUP:
							{
								auto ret = m_Canvas->InputMouseButton(1, false);
								if (ret)
									 ReleaseCapture();
								return ret;
							}
						...
						case WM_MBUTTONDOWN:
							{
								auto ret = m_Canvas->InputMouseButton(2, true);
								if (ret)
								   SetCapture(msg.hwnd);
								return ret;
							}
						...
						case WM_MBUTTONUP:
							{
								auto ret = m_Canvas->InputMouseButton(2, false);
								if (ret)
								 ReleaseCapture();
								return ret;
							}
